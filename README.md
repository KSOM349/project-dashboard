...
<body class="theme-transition" data-theme="light">
    ...
    <!-- Sidebar Navigation -->
    <div class="sidebar card shadow-lg theme-transition" id="sidebar">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h1 class="text-xl font-bold">Security Chaos Engineering</h1>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Group 1 Dashboard</p>
        </div>
        
        <nav class="p-4 space-y-2">
            <button class="nav-btn w-full text-left p-3 rounded-lg theme-transition bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-200" data-section="overview">
                <i class="fas fa-home mr-3"></i>Overview
            </button>
            <button class="nav-btn w-full text-left p-3 rounded-lg theme-transition hover:bg-gray-100 dark:hover:bg-gray-800" data-section="project-documentation">
                <i class="fas fa-folder mr-3"></i>Project Documentation
            </button>
            <button class="nav-btn w-full text-left p-3 rounded-lg theme-transition hover:bg-gray-100 dark:hover:bg-gray-800" data-section="team-collaboration">
                <i class="fas fa-users mr-3"></i>Team Collaboration
            </button>
            <button class="nav-btn w-full text-left p-3 rounded-lg theme-transition hover:bg-gray-100 dark:hover:bg-gray-800" data-section="team-updates">
                <i class="fas fa-bullhorn mr-3"></i>Team Updates
            </button>
            <button class="nav-btn w-full text-left p-3 rounded-lg theme-transition hover:bg-gray-100 dark:hover:bg-gray-800" data-section="ai-assistant">
                <i class="fas fa-robot mr-3"></i>AI Assistant
            </button>
            <button class="nav-btn w-full text-left p-3 rounded-lg theme-transition hover:bg-gray-100 dark:hover:bg-gray-800" data-section="practical-tasks">
                <i class="fas fa-tasks mr-3"></i>Practical Tasks
            </button>
            <button class="nav-btn w-full text-left p-3 rounded-lg theme-transition hover:bg-gray-100 dark:hover:bg-gray-800" data-section="algorithm-visualizer">
                <i class="fas fa-project-diagram mr-3"></i>Algorithm Visualizer
            </button>
            <button class="nav-btn w-full text-left p-3 rounded-lg theme-transition hover:bg-gray-100 dark:hover:bg-gray-800" data-section="my-implementation">
                <i class="fas fa-code mr-3"></i>My Implementation
            </button>
            <button class="nav-btn w-full text-left p-3 rounded-lg theme-transition hover:bg-gray-100 dark:hover:bg-gray-800" data-section="team-dashboard">
                <i class="fas fa-tachometer-alt mr-3"></i>Team Dashboard
            </button>
            <button class="nav-btn w-full text-left p-3 rounded-lg theme-transition hover:bg-gray-100 dark:hover:bg-gray-800" data-section="dijkstra-algorithm">
                <i class="fas fa-network-wired mr-3"></i>Dijkstra Algorithm
            </button>
        </nav>
    ...
    <!-- Main Content -->
    <div class="main-content theme-transition min-h-screen">
        <!-- Header -->
        <header class="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-4 shadow-lg">
            <div class="container mx-auto flex justify-between items-center">
                <div class="flex items-center">
                    <button class="menu-button mr-4 text-white lg:hidden" id="menuButton">
                        <i class="fas fa-bars text-xl"></i>
                    </button>
                    <div>
                        <h1 class="text-2xl font-bold">Security Chaos Engineering Dashboard</h1>
                        <p class="mt-1 opacity-90">Group 1 - Full-Stack Dashboard with Real-time Data</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    <div class="hidden md:flex space-x-2">
                        <div class="text-center p-2 bg-white/20 rounded-lg">
                            <div class="text-sm font-bold" id="cpu-percent">--%</div>
                            <div class="text-xs">CPU</div>
                        </div>
                        <div class="text-center p-2 bg-white/20 rounded-lg">
                            <div class="text-sm font-bold" id="memory-percent">--%</div>
                            <div class="text-xs">Memory</div>
                        </div>
                    </div>
                    <button onclick="fetchSystemData()" class="bg-white/20 hover:bg-white/30 px-3 py-2 rounded-lg transition-all theme-transition">
            ...
            <div class="section-content card rounded-xl shadow-lg p-6 mb-6 hidden" id="practical-tasks">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div class="grid grid-cols-4 gap-4 flex-1">
                        <div class="text-center p-4 bg-blue-50 dark:bg-blue-900/30 rounded-lg theme-transition">
                            <div class="text-2xl font-bold" id="total-tasks-counter">0</div>
                            <div class="text-sm">Total Tasks</div>
                        </div>
                        <div class="text-center p-4 bg-green-50 dark:bg-green-900/30 rounded-lg theme-transition">
                            <div class="text-2xl font-bold" id="completed-tasks-counter">0</div>
                            <div class="text-sm">Completed</div>
                        </div>
                        <div class="text-center p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-lg theme-transition">
                            <div class="text-2xl font-bold" id="inprogress-tasks-counter">0</div>
                            <div class="text-sm">In Progress</div>
                        </div>
                        <div class="text-center p-4 bg-purple-50 dark:bg-purple-900/30 rounded-lg theme-transition">
                            <div class="text-2xl font-bold" id="pending-tasks-counter">0</div>
...
servers = {
    ...
    <script>
            ...
            document.querySelectorAll('.nav-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    document.querySelectorAll('.nav-btn').forEach(b => {
                        b.classList.remove('bg-blue-100', 'text-blue-700', 'dark:bg-blue-900', 'dark:text-blue-200');
                        b.classList.add('hover:bg-gray-100', 'dark:hover:bg-gray-800');
                    });
                    this.classList.remove('hover:bg-gray-100', 'dark:hover:bg-gray-800');
                    this.classList.add('bg-blue-100', 'text-blue-700', 'dark:bg-blue-900', 'dark:text-blue-200');
        ...
        function updateTaskStats() {
            ...
            document.getElementById('inprogress-tasks-counter').textContent = 0;
        }
